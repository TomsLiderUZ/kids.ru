...
const Home = () => {
    ...
    return (
        <div className={styles.home}>
            <div className={styles.container} ref={homeRef} style={{ height: showExtraGames ? "1700px" : "1900px" }}>
                <div className={styles.bg}>
                    <img src="/assets/images/home-bg2.svg" alt=""
                        draggable="false"
                    />

                    {
                        !showExtraGames && <div className={styles.animation}>
                    ...
                    {(showExtraGames ? block2 : block1).map((block, index) => (
                        <div key={index} className={styles.full}>
                            {
                                !showExtraGames ? (<div className={styles.titleCard}>
                                    <h1 className={styles.blockTitle}>{block.name}</h1>
                                </div>) : (
                                    <div className={styles.previousButton}>
                                        <p>Чтобы вернуться к предыдущим <br /> урокам, нажмите на кнопку</p>
                                        <Button onClick={() => setShowExtraGames(false)} className="blue" value="ВЕРНУТЬСЯ" svgLeft={<svg width="28" height="15" viewBox="0 0 28 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M26.1082 6.39062C26.6604 6.39062 27.1082 6.83834 27.1082 7.39062C27.1082 7.94291 26.6604 8.39062 26.1082 8.39062V6.39062ZM0.401047 8.09773C0.0105228 7.70721 0.0105228 7.07404 0.401047 6.68352L6.76501 0.319557C7.15553 -0.0709672 7.7887 -0.0709672 8.17922 0.319557C8.56975 0.710082 8.56975 1.34325 8.17922 1.73377L2.52237 7.39062L8.17922 13.0475C8.56975 13.438 8.56975 14.0712 8.17922 14.4617C7.7887 14.8522 7.15553 14.8522 6.76501 14.4617L0.401047 8.09773ZM26.1082 8.39062H1.10815V6.39062H26.1082V8.39062Z" fill="white" />
                                        </svg>
                                        } />
                                    </div>
                                )
                ...
                <div className={styles.river} style={{ right: showExtraGames ? "-40px" : "0" }}>
