...
const Register = React.memo(() => {
    ...
    const validatePassword = (newPassword, confirmPwd) => {
        if (newPassword.length < 6) return "Пароль должен быть длиной не менее 6 символов.";
        if (newPassword !== confirmPwd) return "Пароли не совпадают, повторите попытку";
        return false;
    };
    ...
    const allInputsFilled = phone?.length > 10 && password && username && confirmPassword && !error;
                ...
                <div className={styles.inputs}>
                    ...
                    <div className={styles.inputHandler}>
                        ...
                        <Input
                            ...
                            className={error ? styles.errorInput : styles.trueInput}
                        />
                        <div className={styles.svgIcon} onClick={togglePasswordVisibility2}>
