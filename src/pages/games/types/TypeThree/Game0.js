...
const Type3 = React.memo(() => {
  ...
  const handleCheckResult = () => {
    const isCorrectAnswer =
      JSON.stringify(droppedColors) === JSON.stringify(correctOrder);
        ...
        <>
          <div className={`${styles.Type2} heightScroll`}>
            <div className={styles.picture}>
              <img
                src="https://i.ibb.co/HpRN06GT/85dbe2a26a87f295a04c4d5826277f64a7502829.png"
                alt="Task"
              />
              <div
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        height: "80px",
                        borderRadius: "15px",
                        backgroundColor: droppedColors[index]
                          ? colorMap[droppedColors[index]]
                          : "transparent",
                        display: "flex",
                        alignItems: "center",
