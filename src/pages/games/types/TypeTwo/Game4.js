...
const TypeOne = React.memo(() => {
  ...
  const imagesStep = [
    "/assets/images/1.5-1.png",
    "/assets/images/1.5-2.png",
    "/assets/images/1.5-2.png",
    "/assets/images/1.5-3.png",
  ];
      ...
      {!videoPlayed ? (
        ...
        <>
          <div className={`${styles.Type2} heightScroll`}>
            <div
              style={{ alignItems: "start", justifyContent: "" }}
              className={`${styles.picture} ${styles.pictureThree}`}
            >
              <div className={styles.imgDiv}>
                <div>
                  <img
                    src={imagesStep[clickMessages.length] || imagesStep[0]}
                    alt=""
                  />
                </div>
              </div>
            ...
            <Title
              text={
                !startGame
                  ? "Ответьте на реплики 1 и 2"
                  : clickMessages.length <= 2
                  ? "Ответьте на реплику 1"
                  : "Ответьте на реплику 2"
              }
            />
            <div className={styles.buttons}>
              {startGame &&
                currentButtons.map(({ id, text }) => (
                  <button
                    key={id}
          ...
          {alertHandler && (
            <Alert
              ...
              onClick={() => {
                ...
                if (isCorrect && clickMessages.length === 4) {
